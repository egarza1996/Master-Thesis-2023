...
% This code analyzes the WHOLE signal (useful for conditions like spontaneous activity and ketamine). 
% Check "BCT_final_segmented" for analysis of only the post-stimulation-windows for optogenetic conditions 1, 2, and 3.
